...
for(nm in fname_no_trend){
  ...
  ggsave(sprintf("C:\\Users\\gpitt\\Pictures\\markov-chains-reserving\\boxplot_nofeatures_ei_%s.eps",tmp.k),
         width = 5.5,
         height= 5,
         device=cairo_ps)
...
for(nm in fname_trend){
  ...
  ggsave(sprintf("C:\\Users\\gpitt\\Pictures\\markov-chains-reserving\\boxplot_features_ei_%s.eps",tmp.k),
         width = 5.5,
         height= 5,
         device=cairo_ps)
